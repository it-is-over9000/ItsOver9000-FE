...
class UserDashboard extends React.Component {
    ...
    changeName = e => {
        ...
        let myName = withAuth()
            ...
            .then (res => {
                console.log(res)
                // return res.data.find(user=> user.username === localName)

                let foundIt = res.data.find(user=> user.username === localName)
                console.log(foundIt)
                return foundIt
            })
        ...
        withAuth()
        .put (`https://over9000be2.herokuapp.com/api/users/${myName.id}`, {username: this.state.username})
        .then (res => {
            console.log(res)
            ...
            <div className="navbar">
                ...
                <div className="user-dashboard-wrapper">
                    <div className="user-dashboard">
                        ...
                        <form onSubmit={this.changeName} className="">
